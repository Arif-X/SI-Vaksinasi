...
<script type="text/javascript">
	$(function () {
		...
		var table = $('.data-table').DataTable({
			processing: true,
			serverSide: true,
			ajax: "{{ route('admin.vaksinasi-kedua.index') }}",
			columns: [
		...
		$('#saveBtn').click(function (e) {
			...
			$.ajax({
				...
				url: "{{ route('admin.vaksinasi-kedua.store') }}",
				type: "POST",
				dataType: 'json',
		...
		$('body').on('click', '.editData', function () {
			...
			$.get("{{ route('admin.vaksinasi-kedua.index') }}" +'/' + id_vaksinasi, function (data) {
		...
		$('body').on('click', '.deleteData', function () {
			...
			$.get("{{ route('admin.vaksinasi-kedua.index') }}" +'/' + vaksinasi_id, function (data) {
		...
		$('#delBtn').click(function (e) {
			...
			var url = '{{ route("admin.vaksinasi-kedua.destroy", ":id") }}';
