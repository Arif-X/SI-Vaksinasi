...
<script type="text/javascript">
	$(function () {
		...
		var table = $('.data-table').DataTable({
			processing: true,
			serverSide: true,
			ajax: "{{ route('pevaksin.vaksinasi-pertama.index') }}",
			columns: [
		...
		$('body').on('click', '.editData', function () {
			...
			$.get("{{ route('pevaksin.vaksinasi-pertama.index') }}" +'/' + user_id, function (data) {
		...
		$('#saveBtn').click(function (e) {
			...
			$.ajax({
				...
				url: "{{ route('pevaksin.vaksinasi-pertama.store') }}",
				type: "POST",
				dataType: 'json',
		...
		$('body').on('click', '.deleteData', function () {
			...
			$.get("{{ route('pevaksin.vaksinasi-pertama.index') }}" +'/' + id_user, function (data) {
		...
		$('#delBtn').click(function (e) {
			...
			var url = '{{ route("pevaksin.vaksinasi-pertama.destroy", ":id") }}';
